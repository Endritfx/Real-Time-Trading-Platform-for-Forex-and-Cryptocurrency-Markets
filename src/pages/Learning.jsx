        ...
        lessons: [
            {
                ...
                content: `
Cryptocurrency is digital money that exists only on the internet and does not rely on banks or governments.
...
Crypto prices can change very quickly, so it is both an opportunity and a risk.
...

            {
                ...
                content: `
Blockchain is the technology behind cryptocurrency. Think of it as a digital record book that stores all transactions.
...
This is what makes crypto different from normal banking systems.
...

            {
                ...
                content: `
Bitcoin is the first cryptocurrency ever created in 2009 by Satoshi Nakamoto.
...
Because it is rare, valuable, and many people use it as long-term storage of value rather than daily spending.
...

            {
                ...
                content: `
Ethereum is not just a cryptocurrency — it is a full blockchain platform.
...
If you lose your private key or seed phrase, there is NO way to recover your funds.
...

            {
                ...
                content: `
A private key is like your secret password that controls your crypto wallet.
        ...
        lessons: [
            {
                ...
                content: `
Hot wallets are connected to the internet and are very easy to use for daily trading and transactions.
...
💡 Most smart users use both: hot wallet for trading, cold wallet for savings.
...

            {
                ...
                content: `
A seed phrase is a backup key that restores your crypto wallet.
...
Treat it like your passport + bank PIN combined.
...

            {
                ...
                content: `
Crypto is usually NOT hacked from the blockchain itself. Instead, people lose money through mistakes and scams.
...
💡 Always use Google Authenticator instead of SMS if possible.
...

            {
                ...
                content: `
To stay safe in crypto, you need strong habits.
...
💡 Think of crypto security like protecting physical cash — once it's gone, it's gone.
...

            {
                ...
                content: `
Most beginners lose money because of simple mistakes, not trading strategy.
        ...
        lessons: [
            {
                ...
                content: `
Trading means buying and selling crypto to make profit from price changes.
...
⚠️ Without knowledge, trading becomes gambling.
                `
            },
...
Nobody knows the perfect bottom or top, so timing is very difficult.
...

            {
                ...
                content: `
Leverage allows you to control a bigger trade using borrowed money from an exchange.
...
👉 Always use leverage carefully.
...

            {
                ...
                content: `
A stop loss is a safety tool that automatically closes your trade when price reaches a certain loss level.
...
Many traders fail because they don’t take profit on time.
...

            {
                title: "Long vs Short",
                content: `
Long = you make profit when price goes UP  
...
Traders use patterns to predict market behavior.
...

            {
                title: "RSI Indicator",
                content: `
RSI measures whether a coin is overbought or oversold.
...
💡 It helps traders find potential reversal points.
...

            {
                ...
                content: `
MACD is used to identify trend direction and momentum.
...
💡 It works best combined with other indicators.
...

            {
                ...
                content: `
Support = price level where market usually stops falling  
        ...
        lessons: [
            {
                ...
                content: `
Smart contracts are programs on blockchain that run automatically when conditions are met.
...
- Collectibles
...

            {
                title: "Staking",
                content: `
Staking means locking your crypto to help secure the network.
...
It is like putting money in a savings account but in crypto form.
...

            {
                title: "Mining",
                content: `
Mining is the process of verifying transactions using powerful computers.
...
- It uses a lot of electricity
...

            {
                title: "Stablecoins",
                content: `
Stablecoins are cryptocurrencies tied to stable assets like USD.
...
💡 They are used to avoid volatility during trading.
    ...
    {
        category: "⚠️ Risk & Psychology",
        lessons: [
            {
                title: "Crypto Volatility",
                content: `
Crypto prices can change very fast within minutes or hours.
...
Always be prepared for sudden market moves.
...

            {
                ...
                content: `
Risk management means protecting your money while trading.
...
You usually buy at the top during hype.
...

            {
                ...
                content: `
Revenge trading is when you try to recover losses quickly.
